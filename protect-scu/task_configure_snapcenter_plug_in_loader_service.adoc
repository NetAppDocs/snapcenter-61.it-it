...
summary: Il servizio SnapCenter Plug-in Loader carica il pacchetto plug-in per consentire a Linux di interagire con SnapCenter Server.  Il servizio SnapCenter Plug-in Loader viene installato quando si installa il pacchetto SnapCenter Plug-ins per Linux. 
---
