...
** Dati presenti sui sistemi primari e secondari ONTAP FAS, AFF o ASA e protetti nell'archiviazione di oggetti e archivi nel cloud (utilizzando l'integrazione BlueXP backup and recovery )
