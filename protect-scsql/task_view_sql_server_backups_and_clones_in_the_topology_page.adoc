...
---
= Visualizza i backup e i cloni di SQL Server nella pagina Topologia
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
La sezione *Scheda riepilogativa* mostra il numero totale di backup e cloni.
...
. Nella vista *Gestisci copie*, fai clic su *Backup* o *Cloni* dall'archivio primario o secondario per visualizzare i dettagli di un backup o di un clone.
+
