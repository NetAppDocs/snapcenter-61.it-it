...
summary: È possibile installare il plug-in SnapCenter per Microsoft SQL Server su più host contemporaneamente utilizzando il cmdlet Install-SmHostPackage di PowerShell. 
---
= Installa il plug-in SnapCenter per Microsoft SQL Server su più host remoti utilizzando i cmdlet
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile installare il plug-in SnapCenter per Microsoft SQL Server su più host contemporaneamente utilizzando il cmdlet Install-SmHostPackage di PowerShell.
