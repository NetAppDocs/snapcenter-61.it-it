...
summary: È necessario creare una connessione al sistema di archiviazione e una credenziale prima di utilizzare i cmdlet di PowerShell per eseguire operazioni di protezione dei dati. 
---
