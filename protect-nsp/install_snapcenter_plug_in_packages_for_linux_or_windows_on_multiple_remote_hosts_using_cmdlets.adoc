...
---
= Installa i pacchetti plug-in SnapCenter per Linux, Windows o AIX su più host remoti utilizzando cmdlet
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile installare i pacchetti plug-in SnapCenter per Linux, Windows o AIX su più host contemporaneamente utilizzando il cmdlet Install-SmHostPackage di PowerShell.
