...
summary: 'SnapCenter supporta i tipi di ripristino SnapRestore \(VBSR\) basati su volume, SnapRestore su file singolo e con connessione e copia per i cluster PostgreSQL rilevati automaticamente.' 
---
