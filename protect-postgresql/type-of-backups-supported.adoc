...
summary: Tipo di backup specifica il tipo di backup che si desidera creare.  SnapCenter supporta il tipo di backup basato sulla copia snapshot per i cluster PostgreSQL. 
---
