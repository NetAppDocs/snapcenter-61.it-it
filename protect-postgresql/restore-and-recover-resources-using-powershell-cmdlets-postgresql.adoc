...
summary: 'Il ripristino di un backup delle risorse include l"avvio di una sessione di connessione con SnapCenter Server, l"elenco dei backup, il recupero delle informazioni di backup e il ripristino di un backup.' 
---
