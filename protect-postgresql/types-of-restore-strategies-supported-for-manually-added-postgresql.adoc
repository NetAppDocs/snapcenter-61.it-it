...
NOTA: il plug-in per PostgreSQL crea un backup_label e una tablespace_map nella cartella _/<OS_temp_folder>/postgresql_sc_recovery_<Restore_JobId>/_ per facilitare il ripristino manuale.
