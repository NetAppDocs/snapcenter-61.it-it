...
summary: 'SnapCenter si integra con l"applicazione plug-in e con le tecnologie NetApp sul sistema di storage.  Per lavorare con il plug-in per il cluster PostgreSQL, utilizzare l"interfaccia utente grafica SnapCenter .' 
---
