...
summary: È necessario creare ruoli cluster ONTAP per i sistemi ASA r2 in modo da non dover utilizzare il ruolo di amministratore ONTAP per eseguire operazioni in SnapCenter. 
---
