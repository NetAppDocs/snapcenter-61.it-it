...
summary: È necessario creare un ruolo cluster ONTAP con privilegi minimi in modo da non dover utilizzare il ruolo di amministratore ONTAP per eseguire operazioni in SnapCenter. 
---
...
NOTE: Dovresti ripetere questo comando per ogni autorizzazione.
