...
summary: 'È necessario creare ruoli SVM se si configurano SVM nei sistemi ASA r2 per l"utilizzo con SanpCenter e non si desidera utilizzare il ruolo vsadmin.' 
---
