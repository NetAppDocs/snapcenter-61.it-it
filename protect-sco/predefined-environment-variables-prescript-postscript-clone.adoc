...
summary: SnapCenter consente di utilizzare le variabili di ambiente predefinite quando si eseguono prescript e postscript durante la clonazione di un database. 
---
= Variabili di ambiente predefinite per prescript e postscript specifici del clone
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
SnapCenter consente di utilizzare le variabili di ambiente predefinite quando si eseguono prescript e postscript durante la clonazione di un database.
...
* *SC_ORACLE_HOME* specifica il percorso della directory home Oracle del database di destinazione.
+
...
* *SC_ORIGINAL_OS_GROUP* specifica il gruppo del sistema operativo del database di origine.
+
Esempio: oinstall

* *SC_TARGET_SID*" specifica il SID del database clonato.
+
Per il flusso di lavoro di clonazione PDB, il valore di questo parametro non sarà predefinito.
...
* *SC_TARGET_OS_GROUP* specifica il gruppo del sistema operativo del database clonato.
+
Per il flusso di lavoro di clonazione PDB, il valore di questo parametro non sarà predefinito.
