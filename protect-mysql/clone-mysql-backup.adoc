...
NOTE: Se i comandi non sono presenti nell'elenco dei comandi, l'operazione fallirà.  * Per la versione MySQL 5.7, è necessario impostare IGNORE_MYSQLX_PORT = true (per impostazione predefinita false) nel file MySQL. properties.
