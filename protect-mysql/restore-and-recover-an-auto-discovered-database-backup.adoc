...
* Il ripristino automatico puntuale e aggiornato al minuto non è supportato.
...
. Nella pagina Ripristina ambito, seleziona *Risorsa completa* per ripristinare i volumi di dati configurati del database MySQL.
