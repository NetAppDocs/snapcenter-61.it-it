...
summary: 'Prima di utilizzare il plug-in SnapCenter per MySQL, l"amministratore SnapCenter deve installare e configurare SnapCenter Server ed eseguire le attività preliminari.' 
---
...
[role="lead"]
Prima di utilizzare il plug-in SnapCenter per MySQL, l'amministratore SnapCenter deve installare e configurare SnapCenter Server ed eseguire le attività preliminari.
