...
Il ripristino completo delle risorse è la strategia di ripristino supportata per i database MySQL rilevati automaticamente.  Ripristina tutti i volumi, i qtree e i LUN di una risorsa.
