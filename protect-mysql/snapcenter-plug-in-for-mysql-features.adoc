...
summary: 'SnapCenter si integra con l"applicazione plug-in e con le tecnologie NetApp sul sistema di storage.  Per lavorare con il plug-in per il database MySQL, utilizzare l"interfaccia utente grafica SnapCenter .' 
---
= Funzionalità del plug-in SnapCenter per MySQL
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
SnapCenter si integra con l'applicazione plug-in e con le tecnologie NetApp sul sistema di storage.  Per lavorare con il plug-in per il database MySQL, utilizzare l'interfaccia utente grafica SnapCenter .
...
+
SnapCenter utilizza la tecnologia snapshot NetApp con il plug-in per il database MySQL per eseguire il backup delle risorse.



L'utilizzo del plug-in per MySQL offre inoltre i seguenti vantaggi:
