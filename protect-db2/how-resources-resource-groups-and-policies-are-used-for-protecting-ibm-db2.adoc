...
---
= Come vengono utilizzate risorse, gruppi di risorse e policy per proteggere IBM Db2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Le risorse sono in genere database IBM Db2 di cui si esegue il backup o la clonazione con SnapCenter.
