...
. Decidi se vuoi creare una policy basata sulla copia di snapshot per eseguire il backup di snapshot coerenti con l'applicazione del database.
. Decidi se vuoi verificare l'integrità del database.
