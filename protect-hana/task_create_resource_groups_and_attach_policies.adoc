...
NOTE: Le coppie chiave-valore personalizzate sono supportate per i sistemi plug-in Linux SAP HANA e non sono supportate per il database SAP HANA registrato come plug-in centralizzato di Windows.
