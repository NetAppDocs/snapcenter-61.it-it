...
---
= Imposta le credenziali per il plug-in SnapCenter per il database SAP HANA
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Fare clic su *Nuovo*.
+
image::../media/install_runas_account.gif[Screenshot per installare l'account RUN AS]
