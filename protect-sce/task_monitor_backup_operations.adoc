...
summary: 'È possibile monitorare l"avanzamento delle diverse operazioni di backup utilizzando la pagina SnapCenterJobs.  Potrebbe essere opportuno controllare lo stato di avanzamento per determinare quando il processo è completato o se si è verificato un problema.' 
---
